...
export const INLINE_COMMAND_INSTRUCTIONS: Record<InlineCommand, string> = {
  ...
  rewrite: `Команда: переписать выделенный фрагмент. Сохрани смысл, события и голос. Сделай естественнее, но не образнее оригинала: новых сравнений и метафор не добавляй, простое слово выразительным синонимом не заменяй. Длина — близко к оригиналу.`,
  ...
  clarify: `Команда: прояснить выделенный фрагмент. Читателю должно стать понятно, кто что делает, где и что произошло. Меняй только то, что мешает пониманию: порядок, неясное местоимение, пропущенное звено. Новых образов, деталей и событий не добавляй. Длина — не больше 120% оригинала.`,
  dedupe: `Команда: убрать повтор в выделенном фрагменте. Найди то, что сказано дважды: одно и то же слово рядом, мысль, которую уже передало действие, пояснение уже понятного. Убери лишнее; остальное оставь дословно. Ничего нового не вписывай. Длина — не больше оригинала.`,
  natural_dialogue: `Команда: сделать реплики в выделенном фрагменте естественнее. Люди в разговоре отвечают не на тот вопрос, недоговаривают, повторяются, говорят проще, чем пишут. Убери из реплик афоризмы и готовые формулировки, пояснения понятного обоим собеседникам. Смысл реплик, кто что сказал и авторский текст между репликами сохрани. Длина — близко к оригиналу.`,
};
