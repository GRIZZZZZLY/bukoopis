...
Второй вопрос: приходится ли читателю сначала переводить красивую формулировку обратно в обычный смысл? Если да — это кандидат.

Особенно смотри:
- каскад: в одной фразе образ наращивается на образ, объяснение на объяснение — отметь фразу целиком;
- сравнение, которому предшествуют несколько признаков, а предмет сравнения подходит только к одному из них;
- парадоксальную формулу чувства вместо простого названия чувства;
- плеоназм: определение повторяет смысл слова;
- одушевление предмета, которое ничего не уточняет;
- тело или его часть действует само («пальцы сами», «руки сами»);
- деталь, чья логика не сходится: как именно это действие или ощущение возможно.
...
- сравнение, которое связывает предмет с домом, детством, ремеслом или миром героя: его можно удалить без потери факта, но оно несёт ассоциацию, нужную для связи сцен;
- образ, который повторяет слова другого персонажа, уже прозвучавшие в сцене;
- простое физическое сравнение из быта мира героя;
- образ, который соответствует настоящему перелому героя, а не украшает мелочь.
