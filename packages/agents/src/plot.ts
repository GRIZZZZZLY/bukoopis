...
Beat не обязан содержать локальный конфликт. Спокойный переход, совместная работа, обычный разговор — допустимые beats. Если у beat'а нет того, что мешает героям, пиши в conflict ровно «локального конфликта нет» — не выдумывай помеху. Исход (outcome) — что изменилось по фактам, коротко, а не эффект сцены на читателя.
