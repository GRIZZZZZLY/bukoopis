...
— Удалить — законная правка. Избыточное пояснение, лишний образ, повтор можно просто убрать, ничего не вписывая взамен («подержал её так, как держат дверь…» → «Ладонь осталась на засове.»). Нарочито «идеальную» последнюю фразу сцены упрощай.
— Замечание вида «чувство не передано» или «покажи через тело» не выполняй телесной реакцией «сама», «раньше, чем понял»: если правка нужна, дай поступок, реплику или прямо названное чувство.
— Правка не делает текст образнее оригинала.
...
Где текст старается — так выполняй замечания о таких местах:
— Перед каждым удалением спроси: узнаём ли мы без этой фразы меньше о персонаже или ситуации? Если нет — удаляй. Если да — оставь, даже если фраза остроумна и замечание просит её убрать.
— Не сокращай содержательное рассуждение персонажа только ради плотности. Если герой перебирает разные версии, планы, причины или последствия, сохраняй различия между ними. Можно упростить формулировки, но нельзя объединять или удалять отдельную гипотезу, если она меняет его понимание ситуации.
— Если действие, реплика или деталь уже показывают эмоцию или мотив, не объясняй их следующим предложением. Убирай пояснение, если без него смысл сохраняется.
— Если в соседних абзацах несколько острот, афоризмов или эффектных формулировок, оставь одну — самую простую и естественную для персонажа. Остальные упрости или убери.
— Проверяй сравнения и метафоры, начиная с самых умных и заметных. Если сравнение прежде всего демонстрирует остроумие автора, а не уточняет восприятие персонажа, убери его. Не заменяй удалённое сравнение другим красивым сравнением.
— Если фраза звучит как готовая цитата, афоризм или подпись для карточки, проверь, естественно ли персонаж подумал или сказал бы её именно сейчас. Если нет — упрости.
— Не сохраняй необычную формулировку только потому, что она выразительная. Если простая конкретная фраза передаёт тот же смысл естественнее, предпочитай простую. Особенно проверяй сочетания слов, которые в буквальном смысле плохо совместимы.
— Не улучшай обычные фразы только ради выразительности. Персонаж может говорить просто, повторяться, отвечать неполно, подбирать слова и иногда быть неостроумным.
— Сохраняй голос персонажа, но не доказывай его в каждом абзаце. Юмор, сарказм и характерные наблюдения должны возникать из ситуации, а не сопровождать каждое действие.
— Предпочитай удаление и упрощение добавлению новой литературной обработки. Если место уже работает, не делай его «сильнее».
— Не переписывай удачные простые фразы только потому, что можешь сделать их красивее.
— Упростить — значит сказать обычными словами или убрать. Не сжимай афоризм в короткую ударную фразу и не делай из остатка новую концовку абзаца.
— Остроумная формулировка рассказчика и простая характерная реплика персонажа — разные вещи. Короткий бытовой обмен репликами, в котором видны отношения героев, не трогай, даже если замечание касается соседнего места.
— После удаления перечитай соседние предложения как единый абзац. Удали или перепиши связки, местоимения и причинные слова, которые потеряли опору: «поэтому», «так что», «вот почему», «это», «от этого», «значит» и подобные. Правка не должна оставлять след удаления.
