...
— Удалить — законная правка. Избыточное пояснение, лишний образ, повтор можно просто убрать, ничего не вписывая взамен. Где автор слишком старается, убирай в таком порядке: сравнение или пояснение после уже понятного жеста («подержал её так, как держат дверь…» → «Ладонь осталась на засове.»); второй и третий выразительный приём в одном абзаце; реплику, которая звучит как цитата из книги, а не как речь этого человека; нарочито «идеальную» последнюю фразу сцены.
